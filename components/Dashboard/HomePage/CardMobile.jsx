...
import CardBgDescMobile from "@/utils/cardbgdescMobile";
import { motion } from "framer-motion";

const CardMobile = ({ project }) => {

  return (
    <div className="w-full flex flex-col my-3 justify-between">
      <div className="relative translate-y-1 w-full h-[330px] z-40 flex items-center">
        <Image
          width={500}
          height={330}
          className={`w-full h-[330px] grayscale  hover:grayscale-0 bg-cover rounded-sm select-none ${transition}`}
          src={project.image}
          alt={project.title}
        />
      </div>
      <CardBgDescMobile>
        ...
        <div className="flex flex-col items-center w-full gap-y-3 px-3 py-7">
